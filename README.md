...
<head>
    ...
    <title>Ciencias - PracticaEjercicios.com</title>
    ...
    <style>
        :root {
            ...
            --danger-color: #dc3545;
            --physics-color: #7b1fa2;
            --chemistry-color: #8e24aa;
            --biology-color: #9c27b0;
        }
...
<body>
    ...
    <script>
        ...
        const exercises = {
            physics: {
                'rectilinear-motion': {
                    basic: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `Calcula la velocidad de un objeto que recorre <strong>${(i + 1) * 10} m</strong> en <strong>${(i + 1) * 2} s</strong>.`,
                        options: [
                            { text: `${5} m/s`, correct: true },
                            { text: `${10 + i} m/s`, correct: false },
                            { text: `${2 + i} m/s`, correct: false },
                            { text: `${20 + i} m/s`, correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! Velocidad = ${(i + 1) * 10} / ${(i + 1) * 2} = 5 m/s.`,
                        feedbackIncorrect: "Incorrecto. Usa la fórmula: velocidad = distancia / tiempo."
                    })),
                    intermediate: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `Un objeto se mueve con una aceleración de <strong>${(i + 1)} m/s²</strong> durante <strong>5 s</strong>. Si su velocidad inicial es 0, ¿cuál es su velocidad final?`,
                        options: [
                            { text: `${(i + 1) * 5} m/s`, correct: true },
                            { text: `${(i + 1) * 10} m/s`, correct: false },
                            { text: `${(i + 1) * 2} m/s`, correct: false },
                            { text: `${(i + 1) * 15} m/s`, correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! Velocidad final = velocidad inicial + aceleración × tiempo = 0 + ${(i + 1)} × 5 = ${(i + 1) * 5} m/s.`,
                        feedbackIncorrect: "Incorrecto. Usa la fórmula: v = u + at."
                    })),
                    advanced: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `Un objeto recorre <strong>${(i + 1) * 100} m</strong> con una velocidad inicial de <strong>10 m/s</strong> y una aceleración de <strong>${(i + 1) * 0.5} m/s²</strong>. ¿Cuánto tiempo tarda?`,
                        options: [
                            { text: `${Math.sqrt(2 * (i + 1) * 100 / ((i + 1) * 0.5)).toFixed(2)} s`, correct: true },
                            { text: `${(Math.sqrt(2 * (i + 1) * 100 / ((i + 1) * 0.5)) + 5).toFixed(2) } s`, correct: false },
                            { text: `${(Math.sqrt(2 * (i + 1) * 100 / ((i + 1) * 0.5)) - 5).toFixed(2) } s`, correct: false },
                            { text: `${(Math.sqrt(2 * (i + 1) * 100 / ((i + 1) * 0.5)) + 10).toFixed(2) } s`, correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! Usando s = ut + ½at², resolvemos para t.`,
                        feedbackIncorrect: "Incorrecto. Usa la fórmula: s = ut + ½at²."
                    }))
                },
                'newton-laws': {
                    basic: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `¿Cuál es la fuerza neta sobre un objeto de <strong>${(i + 1) * 10} kg</strong> que acelera a <strong>2 m/s²</strong>?`,
                        options: [
                            { text: `${(i + 1) * 20} N`, correct: true },
                            { text: `${(i + 1) * 5} N`, correct: false },
                            { text: `${(i + 1) * 10} N`, correct: false },
                            { text: `${(i + 1) * 30} N`, correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! Fuerza = masa × aceleración = ${(i + 1) * 10} × 2 = ${(i + 1) * 20} N.`,
                        feedbackIncorrect: "Incorrecto. Usa la segunda ley de Newton: F = m × a."
                    })),
                    intermediate: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `Un objeto de <strong>${(i + 1) * 5} kg</strong> experimenta una fuerza de <strong>10 N</strong>. ¿Cuál es su aceleración?`,
                        options: [
                            { text: `${2 / (i + 1)} m/s²`, correct: true },
                            { text: `${5 + i} m/s²`, correct: false },
                            { text: `${10 + i} m/s²`, correct: false },
                            { text: `${15 + i} m/s²`, correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! Aceleración = fuerza / masa = 10 / ${(i + 1) * 5} = ${10 / ((i + 1) * 5)} m/s².`,
                        feedbackIncorrect: "Incorrecto. Usa la segunda ley de Newton: F = m × a."
                    })),
                    advanced: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `Calcula la fuerza de fricción si un objeto de <strong>${(i + 1) * 10} kg</strong> se mueve a velocidad constante a pesar de una fuerza aplicada de <strong>20 N</strong>.`,
                        options: [
                        ...
                        feedbackCorrect: "¡Correcto! Si la velocidad es constante, la fuerza neta es 0, por lo que fricción = fuerza aplicada = 20 N (en dirección opuesta).",
                ...
                'electromagnetism': {
                    basic: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `Calcula el campo eléctrico a <strong>${(i + 1) * 2} m</strong> de una carga de <strong>1 μC</strong> (k = 9×10^9).`,
                        options: [
                            { text: `${(9e9 * 1e-6) / Math.pow((i + 1) * 2, 2).toFixed(2)} N/C`, correct: true },
                            { text: `${(9e9 * 1e-6) / ((i + 1) * 2).toFixed(2)} N/C`, correct: false },
                            { text: `${(9e9 * 1e-6) * Math.pow((i + 1) * 2, 2).toFixed(2)} N/C`, correct: false },
                            { text: `${(9e9 * 1e-6) / ((i + 1) * 4).toFixed(2)} N/C`, correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! E = k * q / r² = 9×10^9 * 1×10^-6 / [${(i + 1) * 2}]² = ${(9e9 * 1e-6) / Math.pow((i + 1) * 2, 2).toFixed(2)} N/C.`,
                        feedbackIncorrect: "Incorrecto. Usa la fórmula: E = k * q / r²."
                    })),
                    intermediate: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `Calcula la fuerza entre dos cargas de <strong>1 μC</strong> separadas por <strong>${(i + 1) * 0.1} m</strong> (k = 9×10^9).`,
                        options: [
                            { text: `${(9e9 * 1e-6 * 1e-6) / Math.pow((i + 1) * 0.1, 2).toFixed(2)} N`, correct: true },
                            { text: `${(9e9 * 1e-6 * 1e-6) / ((i + 1) * 0.1).toFixed(2)} N`, correct: false },
                            { text: `${(9e9 * 1e-6 * 1e-6) * Math.pow((i + 1) * 0.1, 2).toFixed(2)} N`, correct: false },
                            { text: `${(9e9 * 1e-6 * 1e-6) / ((i + 1) * 0.2).toFixed(2) } N`, correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! F = k * q1 * q2 / r² = 9×10^9 * 1×10^-6 * 1×10^-6 / [${(i + 1) * 0.1}]² = ${(9e9 * 1e-6 * 1e-6) / Math.pow((i + 1) * 0.1, 2).toFixed(2)} N.`,
                        feedbackIncorrect: "Incorrecto. Usa la ley de Coulomb: F = k * q1 * q2 / r²."
                    })),
                    advanced: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `Calcula la inductancia mutua entre dos bobinas si el flujo en la segunda es <strong>${(i + 1) * 0.1} Wb</strong> cuando la corriente en la primera es 1 A.`,
                        options: [
                            { text: `${(i + 1) * 0.1} H`, correct: true },
                            { text: `${(i + 1) * 0.2} H`, correct: false },
                            { text: `${(i + 1) * 0.05} H`, correct: false },
                            { text: `${(i + 1) * 0.15} H`, correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! M = Φ21 / I1 = ${(i + 1) * 0.1} / 1 = ${(i + 1) * 0.1} H.`,
            ...
            chemistry: {
                'periodic-table': {
                    basic: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `¿Cuál es el número atómico del elemento número <strong>${i + 1}</strong> en la tabla periódica?`,
                        options: [
                            { text: `${i + 1}`, correct: true },
                            { text: `${i + 2}`, correct: false },
                            { text: `${i + 3}`, correct: false },
                            { text: `${i + 4}`, correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! El número atómico es ${i + 1}.`,
                        feedbackIncorrect: "Incorrecto. El número atómico es la posición en la tabla periódica."
                    })),
                    intermediate: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `¿Cuántos electrones tiene un átomo neutro del elemento con número atómico <strong>${i + 1}</strong>?`,
                        options: [
                            { text: `${i + 1}`, correct: true },
                            { text: `${i + 2}`, correct: false },
                        ...
                        feedbackCorrect: `¡Correcto! Un átomo neutro tiene el mismo número de electrones que su número atómico, ${i + 1}.`,
                        feedbackIncorrect: "Incorrecto. En átomos neutros, electrones = protones = número atómico."
                    })),
                    advanced: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `¿Cuál es la configuración electrónica del elemento con número atómico <strong>${i + 1}</strong>? (Simplificado)`,
                        options: [
                            { text: `[Ar] 4s${(i % 2) + 1}3d${i % 10}`, correct: true },
                            { text: `[Ne] 3s${(i % 2) + 1}`, correct: false },
                            { text: `[Kr] 5s${(i % 2) + 1}`, correct: false },
                            { text: `[Xe] 6s${(i % 2) + 1}`, correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! La configuración es simplificada para el elemento ${i + 1}.`,
                ...
                'chemical-reactions': {
                    basic: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `Balancea la reacción: <strong>H₂ + O₂ → H₂O</strong>`,
                        options: [
                    ...
                    intermediate: Array.from({ length: 50 }, (_, i) => ({
                        ...
                        feedbackCorrect: "¡Correcto! CH₄ + 2O₂ → CO₂ + 2H₂O.",
                        feedbackIncorrect: "Incorrecto. Asegúrate de que el número de átomos sea igual en ambos lados."
                    })),
                    advanced: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `Balancea la reacción: <strong>Al + O₂ → Al₂O₃</strong>`,
                        options: [
                            { text: "4Al + 3O₂ → 2Al₂O₃", correct: true },
                            { text: "Al + O₂ → Al₂O₃", correct: false },
                            { text: "2Al + O₂ → Al₂O₃", correct: false },
                            { text: "Al + 2O₂ → Al₂O₃", correct: false }
                        ],
                        feedbackCorrect: "¡Correcto! 4Al + 3O₂ → 2Al₂O₃.",
                        feedbackIncorrect: "Incorrecto. Asegúrate de que el número de átomos sea igual en ambos lados."
                    }))
                },
                'stoichiometry': {
                    basic: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `Calcula la masa molar de <strong>CO₂</strong>`,
                        options: [
                        ...
                        feedbackCorrect: "¡Correcto! Masa molar de CO₂ = 12 + 16*2 = 44 g/mol.",
                        feedbackIncorrect: "Incorrecto. Suma las masas atómicas: C = 12, O = 16*2 = 32, total 44 g/mol."
                    })),
                    intermediate: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `¿Cuántos moles hay en <strong>${(i + 1) * 44} g</strong> de CO₂ (masa molar 44 g/mol)?`,
                        options: [
                            { text: `${i + 1}`, correct: true },
                            { text: `${i + 2}`, correct: false },
                            { text: `${i + 3}`, correct: false },
                        ...
                        feedbackCorrect: `¡Correcto! Moles = masa / masa molar = ${(i + 1) * 44} / 44 = ${i + 1}.`,
                        feedbackIncorrect: "Incorrecto. Moles = masa / masa molar."
                    })),
                    advanced: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `En la reacción 2H₂ + O₂ → 2H₂O, ¿cuántos moles de H₂O se producen a partir de <strong>${(i + 1)} moles</strong> de H₂?`,
                        options: [
                            { text: `${i + 1}`, correct: true },
                            { text: `${(i + 1) * 2}`, correct: false },
                            { text: `${(i + 1) / 2}`, correct: false },
                            { text: `${i + 1} / 4`, correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! Según la estequiometría, 2 moles de H₂ producen 2 moles de H₂O, por lo que ${(i + 1)} moles de H₂ producen ${(i + 1)} moles de H₂O.`,
            ...
            biology: {
                'cells': {
                    basic: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `¿Cuál es la función principal de la <strong>${i % 2 === 0 ? 'mitocondria' : 'núcleo'}</strong>?`,
                        options: i % 2 === 0 ? [
                        ...
                        feedbackCorrect: `¡Correcto! La ${i % 2 === 0 ? 'mitocondria produce energía' : 'núcleo almacena ADN'}.`,
                        feedbackIncorrect: "Incorrecto. Revisa las funciones de los orgánulos celulares."
                    })),
                    intermediate: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `¿Cuál es la función del <strong>${i % 2 === 0 ? 'retículo endoplasmático' : 'aparato de Golgi'}</strong>?`,
                        options: i % 2 === 0 ? [
                            { text: "Síntesis y transporte de proteínas", correct: true },
                            { text: "Producción de energía", correct: false },
                            { text: "Almacenar ADN", correct: false },
                            { text: "Degradar desechos", correct: false }
                        ] : [
                            { text: "Modificación y empaquetado de proteínas", correct: true },
                            { text: "Producción de energía", correct: false },
                            { text: "Almacenar ADN", correct: false },
                            { text: "Síntesis de lípidos", correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! El ${i % 2 === 0 ? 'retículo endoplasmático se encarga de la síntesis y transporte de proteínas' : 'aparato de Golgi modifica y empaqueta proteínas'}.`,
                        feedbackIncorrect: "Incorrecto. Revisa las funciones de los orgánulos celulares."
                    })),
                    advanced: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `¿Qué proceso ocurre en la <strong>${i % 2 === 0 ? 'mitocondria' : 'cloroplasto'}</strong>?`,
                        options: i % 2 === 0 ? [
                        ...
                        feedbackCorrect: `¡Correcto! En la ${i % 2 === 0 ? 'mitocondria ocurre la respiración celular' : 'cloroplasto ocurre la fotosíntesis'}.`,
                ...
                'ecology': {
                    ...
                    intermediate: Array.from({ length: 50 }, (_, i) => ({
                        id: i + 1,
                        question: `¿Cuál es el nivel trófico de un <strong>${i % 2 === 0 ? 'productor' : 'consumidor primario'}</strong>?`,
                        options: i % 2 === 0 ? [
                            { text: "Primer nivel trófico", correct: true },
                            { text: "Segundo nivel trófico", correct: false },
                            { text: "Tercer nivel trófico", correct: false },
                            { text: "Cuarto nivel trófico", correct: false }
                        ] : [
                            { text: "Segundo nivel trófico", correct: true },
                            { text: "Primer nivel trófico", correct: false },
                            { text: "Tercer nivel trófico", correct: false },
                            { text: "Cuarto nivel trófico", correct: false }
                        ],
                        feedbackCorrect: `¡Correcto! Un ${i % 2 === 0 ? 'productor está en el primer nivel trófico' : 'consumidor primario está en el segundo nivel trófico'}.`,
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('.exercise-tab').forEach(tab => {
                tab.addEventListener('click', () => {
                    ...
                    loadExercise(tab.dataset.tab.split('-')[0], tab.dataset.tab.split('-')[1], tab.dataset.tab.split('-')[2], 0);
                });
            });
            ...
            document.querySelectorAll('.next-question-btn').forEach(btn => {
                btn.addEventListener('click', () => {
                    ...
                    const topic = tab.split('-')[1];
                    const level = tab.split('-')[2];
        ...
        function loadExercise(subject, topic, level, index) {
            ...
            const exercise = exercises[subject][topic][level][index];
        ...
        document.querySelectorAll('.exercise-tab.active').forEach(tab => {
            ...
            const topic = tabId.split('-')[1];
            const level = tabId.split('-')[2];
